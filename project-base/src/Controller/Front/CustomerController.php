...
class CustomerController extends FrontBaseController
{
    ...
    public function editAction(Request $request)
    {
        ...
        $deliveryAddress = $form->get('deliveryAddressData')->get('deliveryAddress')->getData();

        if ($form->isSubmitted() && $form->isValid()) {
            $customerUserUpdateData = $form->getData();

            $this->customerUserFacade->editByCustomerUser($customerUser->getId(), $customerUserUpdateData, $deliveryAddress);
